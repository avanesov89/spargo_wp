<?php
/**
 * Шаблон отображения обычного поста блога
 * @var $args
 */
...
<div class="wrapper">
  ...
  <?php get_template_part('templates/widgets/last-posts', 'bottom', ['term_id' => $top_category->term_id]); ?>
</div>
